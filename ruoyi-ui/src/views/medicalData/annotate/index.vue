...
export default {
  ...
  data() {
    return {
      ...
      radio9: '',
      markData: {
        jiazhuangxianshizhimiman: 0,
        jzxShiFoushuangceexing: 0,
        jzxDuofabingzhao: 0,
        jzxWeizhiShangji: 0,
        jzxWeizhiXiaji: 0,
        jzxWeizhiZhongbu: 0,
        jzxWeizhiXiabu: 0,
        jzxZuZhibingliLiangxing: 0,
        jzxZuzhibingliRutouzhuangai: 0,
        jzxZuzhibingliSuiyangai: 0,
        jzxZuzhibingliLvpaozhuangai: 0,
        jzxZuzhibingliQitaexing: 0,
        jzxJiejiezuidajing: 0,
        jzxNeibujiegouShixing: 0,
        jzxNeibujiegouShixingweizhu: 0,
        jzxNeibujiegouNangxingweizhu: 0,
        jzxNeibujiegouNangshixing: 0,
        jzxNeibujiegouHaimianyang: 0,
        jzxNeibujiegouNangxing: 0,
        jzxNeibujiegouWufapanduan: 0,
        jzxHuishengGaohuisheng: 0,
        jzxHuishengDenghuisheng: 0,
        jzxHuishengDihuisheng: 0,
        jzxHuishengJidihuisheng: 0,
        jzxHuishengWufapanduan: 0,
        jzxXingzhuangDayuDengyu: 0,
        jzxXingzhuangxiaoyu: 0,
        jzxBianyuanGuangzheng: 0,
        jzxBianyuanBuguize: 0,
        ...
        jzxJuzhaoqianghuishengHuixingwei: 0,
        lbjDaxiaoShuipingjing: 0,
        lbjDaxiaoCuizhijing: 0,
        lbjXingzhuangTuoyuan: 0,
        lbjXingzhuangLeiyuan: 0,
        lbjXingzhuangBuguize: 0,
        lbjBianyuanGuangzheng: 0,
        lbjLinbamenZhengchang: 0,
        lbjLinbamenPianxin: 0,
        lbjLinbamenXiaoshi: 0,
        lbjLinbamenGaohuishengTuankuai: 0,
        lbjPizhiJunyunZenghou: 0,
        lbjPizhiBujunyunZenghou: 0,
        lbjNeijunzhiGaohuisheng: 0,
        lbjYehua: 0,
        lbjGaihua: 0,
        lbjXueliuZhengchang: 0,
        lbjXueliuMenxing: 0,
        lbjXueliuBianyuanweizhuxing: 0,
        lbjXueliuHunhexing: 0,
        lbjBinglijiegou: 0,
      }
    };
  },
